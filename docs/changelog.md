...
## [0.5.0](https://github.com/nhairs/pillar/compare/v0.4.0...v0.5.0) - 2026-03-01

### Fixed

- [#1](https://github.com/nhairs/pillar/issues/1) `LoggingManifest.additional_manifest` throws `TypeError` in `Application._setup_logging` on Python 3.14. This also removes `dataclassy` as a dependency.
